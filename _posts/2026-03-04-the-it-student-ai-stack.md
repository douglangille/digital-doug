...
tags: [learning,technology,tools,ai]
header:
...
1. Go to [GitHub.com](https://github.com) → Sign up with your **personal email** (takes 2 minutes, use personal not school, so your account survives graduation)
...
- "School email not recognized" → Upload a document instead. If you're at a college without a recognized .edu domain (hi, NSCC), budget a few days and some patience.
...
Go to [GitHub.com](https://github.com) → Copilot tab → ask a question. Works on your phone, works on a tablet. No install, no setup, no excuse. Good for talking through a technical problem, drafting documentation, debugging logic before you write a line of code. Open and use.
